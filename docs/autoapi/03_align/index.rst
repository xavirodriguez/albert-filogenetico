...
.. py:function:: run_mafft(input_file: str, output_file: str, config: Dict[str, Any]) -> None

   Execute MAFFT alignment with configured parameters.

   :param input_file: Path to the input filtered FASTA file.
   :type input_file: :py:class:`str`
   :param output_file: Path where the aligned FASTA will be saved.
   :type output_file: :py:class:`str`
   :param config: Configuration dictionary containing tool paths.
